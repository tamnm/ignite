...
public class LuceneResultSet implements ResultSet,ResultSetMetaData {
    ...
    public LuceneResultSet(Iterator<Object[]> iterator, Column[] columns) {
    ...
    @Override
    public int getRow() {
        return currentRow == null? 0 : rowId;
    }
    ...
    public int findColumn(String columnLabel) throws SQLException {
        if (columnLabel != null && columns != null) {
            for (int i = 0, size = columns.length; i < size; i++) {
                if (columnLabel.equalsIgnoreCase(getColumn(i).getName())) {
                    return i + 1;
                }
            }
        }
    ...
    public int getColumnType(int columnIndex) throws SQLException {
        return DataType.convertTypeToSQLType(getColumn(columnIndex - 1).getType());
    }
    ...
    public int getPrecision(int columnIndex) throws SQLException {
        return (int) getColumn(columnIndex - 1).getPrecision();
    }
    ...
    public String getColumnLabel(int columnIndex) throws SQLException {
        return getColumn(columnIndex - 1).getName();
    }
    ...
    public String getColumnTypeName(int columnIndex) throws SQLException {
        int valueType = DataType.convertSQLTypeToValueType(getColumnType(columnIndex));
    ...
    protected static class It implements Iterator<Object[]>{
        ...
        private void findNext() throws IgniteCheckedException {
            ...
            while (batchPos < batch.length) {
                ...
                Object k = unmarshall(doc.getBinaryValue(KEY_FIELD_NAME).bytes, ldr);

                Object[] v;
                if(k instanceof BinaryObjectImpl){
                    v = getValue((BinaryObjectImpl) k, doc);
                }else {
                    v = getValue(k, doc);
                }
        ...
        private Object[] getValue(Object key, Document doc){
        ...
        private Object[] getValue(BinaryObjectImpl key, Document doc){
            Object[] values = new Object[columns.length];
